...
class MainWin(Tk):
    def __init__(self):
        ...
        self.canvas = Canvas(width=1366, height=768, bg='midnight blue')
        self.canvas.pack()
        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    self.srt = Button(self, text='Search', width=15, font=('arial', 10),command = sest).place(x=1000, y=106)
                    ...
                    self.button =Button(self, text='Add Book', width=10, font=('Courier new', 10), command=a_b).place(x=150,y=250)
                    self.button = Button(self, text='Add Student', width=15, font=('Courier new', 10), command=a_s).place(x=270,y=250)
